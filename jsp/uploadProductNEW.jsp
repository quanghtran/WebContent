...
<body>
	...
	<div id="wrap">
		...
		<div class="container">
			...
			<!-- 				<span class="glyphicon glyphicon-product"></span>Upload Product -->
			<!-- 			</h1> -->
			<!-- 			<hr> -->
			<!-- 			<div class="col-md-3"> -->
			<!-- 				<div class="text-center"> -->
			<!-- 					<img src="//placehold.it/100" class="img-thumbnail" alt="image"> -->
					...
					<div class="form-group">
						...
						<div class="col-xs-4">
							...
							<div style="position: relative;">
								<a class='btn btn-primary' href='javascript:;'> Browse
									<input type="file"

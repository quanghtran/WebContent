      ...
      <div class="modal-content">
		...
		<c:if test='${requestScope["login"] == "passwordFailure"}'>
			<div id="passwordFail" class="alert alert-warning">
   				...
   				<strong>Warning!</strong> Password mismatch with the given email address. <a href="action.do?action=password&email=${requestScope['email']}">Forgot Password?</a>
			</div>
		</c:if>
		...
		<c:if test='${requestScope["recovery"] == "success"}'>
			<div id="recovery" class="alert alert-success">
   				<a href="#" class="close" data-dismiss="alert">&times;</a>
   				<strong>Success!</strong> Password has been sent to ${requestScope["email"]}. 
			</div>
		</c:if>
